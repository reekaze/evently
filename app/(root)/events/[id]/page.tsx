                    ...
                    <div className='flex w-full flex-col gap-8 p-5 md:p-10'>
                        <div className='flex flex-col gap-6'>
                            ...
                            <div className='flex flex-col gap-3 sm:flex-row sm:items-center'>
                                <div className='flex gap-3'>
                                    <p className='flex-center text-center p-bold-20 rounded-full bg-green-500/10 px-5 py-2 text-green-700'>
                                        {event.isFree ? "FREE" : `$${event.price}`}
                                    </p>
                                    <p className='flex-center text-center p-medium-16 rounded-full bg-grey-500/10 px-4 py-2.5 text-grey-500'>
                                        {event.category.name}
                                    </p>
                                </div>
                        ...
                        <div className='flex flex-col gap-5'>
                            <div className='flex gap-2 md:gap-3'>
                                ...
                                <div className='gap-2 p-medium-16 lg:p-regular-20 flex flex-wrap items-center'>
                                    <p>
